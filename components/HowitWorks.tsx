      ...
      <section className="flex md:flex-row flex-col justify-between gap-7">
        <div className="bg-[#ecf5fe] w-full rounded-sm border p-4 flex flex-col gap-3">
          ...
          <span className="text-secondary-foreground">
            Click get started and wait for MediMind to start your consultation.
          </span>
          <span className="text-yellow-600 text-sm">
            Disclaimer: MediMind may provide inaccurate responses and is not
        ...
        <div className="bg-[#ecf5fe] w-full  rounded-sm border p-4 flex flex-col gap-3">
          ...
          <span className="text-secondary-foreground">
            MediMind uses OPENAI Chat Completion software to answer your medical
